...
Software checks and builds can support software-readiness claims only. They do
not prove board wiring, physical ALERT behavior, humidity accuracy, fault
recovery under real bus faults, or long-term stability.

Safe current wording:

- software-hardened;
- locally software-tested;
- pre-HIL-ready;
- CI-configured.
...
- a hardware pass;
- an ALERT pin pass;
- a humidity accuracy pass;
- pure ESP-IDF validated without a passing CI or local IDF build log;
- released/tagged from this branch;
- field-proven or industry-grade.
