...
static constexpr const char* BUILD_DATE = "2026-01-20";

/// @brief Build time (HH:MM:SS).
static constexpr const char* BUILD_TIME = "12:00:00";

/// @brief Full build timestamp.
static constexpr const char* BUILD_TIMESTAMP = "2026-01-20 12:00:00";

/// @brief Git commit hash (short).
static constexpr const char* GIT_COMMIT = "release";
...
static constexpr const char* VERSION_FULL = "1.0.0 (release, 2026-01-20 12:00:00)";
